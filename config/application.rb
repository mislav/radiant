...
module Radiant
  class Application < Rails::Application
    ...
    # This value is used as configuration for Rack::Sendfile.
    # Set to "X-Sendfile" for support for Apache with mod_xsendfile or lighttpd.
    # Set to "X-Accel-Redirect" for nginx. Additional server config might be needed.
    # See Rack::Sendfile documentation for details.
